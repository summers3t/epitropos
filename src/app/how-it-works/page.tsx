...
export default function HowItWorksPage() {
    return (
        <section className="mx-auto w-full max-w-[1440px] space-y-10 px-6 py-16 md:py-20">
            ...
            <div className="group grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                {steps.map((item) => (
                    <article
                        key={item.step}
                        className="rounded-[26px] border border-white/10 bg-white/[0.04] p-6 shadow-[0_18px_60px_rgba(0,0,0,0.15)] backdrop-blur transition duration-300 group-hover:opacity-60 hover:-translate-y-1 hover:opacity-100 hover:shadow-[0_28px_70px_rgba(0,0,0,0.22)]"
                    >
