  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#efe7d8] text-[#2f3130]">
      <div className="pointer-events-none fixed inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(166,139,74,0.12),transparent_26%),radial-gradient(circle_at_top_right,rgba(15,28,46,0.10),transparent_24%),linear-gradient(180deg,#f6f0e6_0%,#eee4d2_48%,#e9deca_100%)]" />
        <div className="client-portal-bg-image" />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.48),rgba(255,248,239,0.30)_18%,rgba(239,231,216,0.78)_100%)]" />
        <div className="absolute inset-x-0 top-0 h-[360px] bg-[linear-gradient(180deg,rgba(255,255,255,0.44),transparent)]" />
      </div>
      ...
      <div className="relative mx-auto w-full max-w-[1520px] px-4 py-8 md:px-8 md:py-10 xl:px-10">
        <div className="client-glass-panel rounded-[36px]">
          <div className="border-b border-[#d7c5ac] bg-[linear-gradient(180deg,rgba(15,28,46,0.94),rgba(24,40,63,0.90))] px-5 py-5 md:px-8 md:py-6 xl:px-10">
                  ...
                  return (
                    <Link
                      ...
                      className={`client-interactive client-focus-ring inline-flex items-center gap-2 rounded-full border px-4 py-2.5 text-[11px] uppercase tracking-[0.18em] ${active
                          ? "border-[#d1bb8c] bg-[#f5ecdc] text-[#0f1c2e] shadow-none"
                          : "border-transparent bg-transparent text-[#e0e5ea] hover:border-white/14 hover:bg-white/[0.10] hover:text-white hover:shadow-[0_10px_24px_rgba(0,0,0,0.12)] active:bg-white/[0.14]"
                        }`}
                    >
